...
#define LOOP while(1) { __VB_C_CPP_ARGS __VB_C_CPP_LB
#define __VB_C_CPP_WHILE(cond) if (!(cond)) { break; }
#define WHILE __VB_C_CPP_RB __VB_C_CPP_WHILE __VB_C_CPP_LB
#define SKIP __VB_C_CPP_RB
#define OTHERWISE ) { continue; } __VB_C_CPP_ARGS __VB_C_CPP_LB
#define DO __VB_C_CPP_RB __VB_C_CPP_ARGS __VB_C_CPP_LB
#define END_LOOP __VB_C_CPP_RB }
